...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  ...
  const header = hasClerkConfig
    ? (() => {
        // Dynamic require verhindert, dass Next.js den Header bei fehlendem Clerk-Key entfernt
        const Header = require("@/components/Header").default as React.ComponentType;
        return <Header />;
      })()
    : null;
